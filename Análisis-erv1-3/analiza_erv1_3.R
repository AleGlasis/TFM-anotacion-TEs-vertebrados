# =============================================================
# Uso desde terminal:
#   Rscript analiza_erv1_3.R archivo1.bed archivo2.bed [resultado.txt] [tolerancia]
# =============================================================

args <- commandArgs(trailingOnly = TRUE)

if (length(args) < 2) {
  stop("Uso: Rscript analiza_erv1_3.R archivo1.bed archivo2.bed [resultado.txt] [tolerancia]")
}
...
cat("Leyendo archivo 1...\n")
df1 <- leer_bed(ruta_bed1)
cat("Leyendo archivo 2...\n")
...
cat("COMPARACIÓN DE ARCHIVOS BED - ERV1-3\n")
