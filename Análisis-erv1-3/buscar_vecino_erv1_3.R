...
# =============================================================
# Uso:
#   Rscript buscar_vecino_unico.R comparacion.txt bed1.bed bed2.bed salida.txt
# =============================================================

args <- commandArgs(trailingOnly = TRUE)

if (length(args) < 3) {
  stop("Uso: Rscript buscar_vecino_unico.R comparacion.txt bed1.bed bed2.bed [salida.txt]")
}
...
parsear_linea <- function(linea) {
  # Formato: chr1  34345504-34345642  ERV1-3C_DR-LTR
...
cat("Únicos en archivo 1:", length(unicos$unicos1), "\n")
cat("Únicos en archivo 2:", length(unicos$unicos2), "\n")
...
cat("Listo. Resultados guardados en:", nombre_salida, "\n")