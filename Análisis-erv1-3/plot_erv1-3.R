...
# ==============================================================================
# Uso desde bash:
#   Rscript grafica_vecinos_archivo2.R <ruta_archivo> [ruta_salida.png] [umbral_%]
#
# Ejemplos:
#   Rscript grafica_vecinos_archivo2.R vecinos_erv1_3.txt
#   Rscript grafica_vecinos_archivo2.R vecinos_erv1_3.txt mi_grafica.png 1
#   Rscript grafica_vecinos_archivo2.R vecinos_erv1_3.txt mi_grafica.png 2.5
# ==============================================================================

args <- commandArgs(trailingOnly = TRUE)

if (length(args) < 1) {
  stop("Uso: Rscript grafica_vecinos_archivo2.R <ruta_archivo> [ruta_salida.png] [umbral_%]")
}
...
grafica <- ggplot2::ggplot(
  ...
  ggplot2::coord_flip() +
  ggplot2::labs(
    title    = "Vecinos más cercanos en archivo 1",
    subtitle = subtitulo,
    x = NULL,
    y = "Proporción"
  ) +
